# Posti SCS OpenAPI Specification
[![Build Status](https://travis-ci.org/jiivari/PostiAPI.svg?branch=master)](https://travis-ci.org/jiivari/PostiAPI)
...
6. If you did everything correct, https://jiivari.github.io/PostiAPI/ will lead to your new docs
...
- Preview spec version for branch `[branch]`: https://jiivari.github.io/PostiAPI/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://jiivari.github.io/PostiAPI/ with url from the message: `Server started <url>`
